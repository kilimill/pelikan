    ...
    <div class="btn-group palette-buttons" role="group">
        ...
        <ul class="dropdown-menu">
          <li v-for="size of sizes" :key="size">
            <button
              type="button"
              class="dropdown-item"
              @click="brush.size = size.procent"
              :class="{ active: brush.size === size.procent }"
            >
              {{ size.name }}
            </button>
          </li>
      ...
      <div class="btn-group dropup select-color">
        <button
          ...
          aria-expanded="false"
        >
          <span class="material-icons" :style="{ color: brushColor }"
  ...
  setup() {
    ...
    const hasActions = computed(() =>
      activePresentation.value
        ? store.getters["room/presentations/draw/hasDrawActions"](
