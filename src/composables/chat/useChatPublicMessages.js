...
import {
    SORT_TIME,
    SORT_USER
} from "@/store/modules/tabs/chat/public";
...
export default function useChatPublicMessages() {
    ...
    return {
        ...
        publicMessages: computed(() => ({
            ...
            [SORT_USER]: unsortedMessages.value.map(i => i).sort((a, b) => {
        ...
        publicMarkAsRead: () => store.commit('tabs/highlightComponent', {
            name: 'TabChat',
            highlight: false
        }),
    }
