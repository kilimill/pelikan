export class Player{
    ...
    setSnapshotInterval () {
        ...
        this.snapshotInterval = setInterval(() => {
            ...
            if(canvasAreaHeight === 0){
                canvasAreaHeight = 150
            }

            canvasWidth = canvasAreaWidth;
            canvasHeight = canvasAreaHeight;
    ...
    setLoadedDataEvent () {
        this.elementPlayer.addEventListener(
          'loadeddata',
          () => {
              if(this.elementPlayer.paused){
                  this.elementPlayer.play()
              }
